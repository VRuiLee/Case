...
previous_inputs = set() #Gör till en set (tar bort duplicates)
...
def validate_input(data):
    ...
    validations = {
        ...
        "No duplicates": data not in previous_inputs,
    }

    # Add data in previous inputs for duplicate check
    if validations["No duplicates"]:
        previous_inputs.add(data)
